...
public class JiraReplaceFixVersionByRegExTest {
  ...
  public void replaceWithFixVersionByRegex() throws URISyntaxException, TimeoutException {
    ...
    myVersions.add(
        new ExtendedVersion(new URI("self"), 0L, TO_VERSION, null, false, false, null, null));
    ...
    assertThat(secondIssueUpdatedFixVersions.get(0),
        equalTo(CollectionUtils.get(issues.get(1).getFixVersions(), 0)));
  ...
  private Issue getIssue(String fixVersion, long id) throws URISyntaxException {
    ...
    return new Issue("", new URI(""), PROJECT_KEY + id, id, null, null, null, null, null, null,
        null, null, null, null, null, null, null, fixVersions, null, null, null, null, null,
