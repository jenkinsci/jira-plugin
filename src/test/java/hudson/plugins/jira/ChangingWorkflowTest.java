...
/**
 * User: lanwen Date: 10.09.13 Time: 0:57
 */
...
public class ChangingWorkflowTest {
  ...
  public void getActionIdReturnsNullWhenServiceReturnsNull() throws Exception {
    ...
    assertThat(spySession.getActionIdForIssue(ISSUE_JQL, NON_EMPTY_WORKFLOW_LOWERCASE),
        nullValue());
  }
  ...
  public void getActionIdIteratesOverAllActionsEvenOneOfNamesIsNull() throws Exception {
    ...
    when(restService.getAvailableActions(ISSUE_JQL))
  ...
  public void getActionIdReturnsNullWhenNullWorkflowUsed() throws Exception {
    ...
    when(restService.getAvailableActions(ISSUE_JQL))
        .thenReturn(Collections.singletonList(action1));
  ...
  @Test
  public void addCommentsOnNonEmptyWorkflowAndNonEmptyComment()
    ...
    when(site.progressMatchingIssues(anyString(), anyString(), anyString(),
        Matchers.any(PrintStream.class)))
        .thenCallRealMethod();
  ...
  public void dontAddCommentsOnNullWorkflowAndNullComment() throws IOException, TimeoutException {
    ...
    verify(mockSession, never())
        .addComment(anyString(), anyString(), isNull(String.class), isNull(String.class));
  }
