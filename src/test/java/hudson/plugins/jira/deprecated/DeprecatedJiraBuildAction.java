...
/**
 * Old version of class JIRA issues related to the build. Used only in junit test
 * JiraBuildActionTest for testing version transition compatibility of PR-72.
 */
