...
public class JiraSiteSecurity1029Test {
  ...
  public void cannotLeakCredentials() throws Exception {
    ...
    UsernamePasswordCredentialsImpl cred1 = new UsernamePasswordCredentialsImpl(
        CredentialsScope.GLOBAL, credId_1, null, "user1", pwd1);
    UsernamePasswordCredentialsImpl cred2 = new UsernamePasswordCredentialsImpl(
        CredentialsScope.GLOBAL, credId_2, null, "user2", pwd2);
    ...
    { // as an admin I should be able to validate my url / credentials
      ...
      String jiraSiteValidateUrl =
          j.getURL() + "descriptorByName/" + JiraSite.class.getName() + "/validate";
    ...
    { // as an user with just read access, I may not be able to leak any credentials in folder
      Folder folder = j.jenkins
          .createProject(Folder.class, "folder" + j.jenkins.getItems().size());
  ...
  private static class FakeJiraServlet extends DefaultServlet {
    ...
    private void myPermissions(HttpServletRequest req, HttpServletResponse resp)
        throws IOException {
