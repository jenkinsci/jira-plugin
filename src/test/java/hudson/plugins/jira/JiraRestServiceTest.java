...
public class JiraRestServiceTest {
  ...
  public void createMocks() throws InterruptedException, ExecutionException, TimeoutException {
    ...
    when(searchRestClient.searchJql(Mockito.anyString(), Mockito.anyInt(), Mockito.anyInt(),
  ...
  public void baseApiPath() {
    JiraRestService service = new JiraRestService(JIRA_URI, client, USERNAME, PASSWORD,
  ...
  public void getIssuesFromJqlSearchTimeout()
      throws TimeoutException, InterruptedException, ExecutionException {
    JiraRestService service = spy(
