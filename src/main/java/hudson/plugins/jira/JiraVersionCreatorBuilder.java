...
/**
 * A build step which creates new Jira version. It has the same functionality as {@link
 * JiraVersionCreator} but can be used multiple times in the same build (e.g. for different
 * projects) and supports conditional triggering.
 *
...
public class JiraVersionCreatorBuilder extends Builder implements SimpleBuildStep {
  ...
  public void perform(Run<?, ?> build, FilePath workspace, Launcher launcher,
    ...
    new VersionCreator()
        .perform(build.getParent(), jiraVersion, jiraProjectKey, build, listener);
  }
  ...
  public static class DescriptorImpl extends BuildStepDescriptor<Builder> {
    ...
    @Override
    public JiraVersionCreatorBuilder newInstance(StaplerRequest req, JSONObject formData)
