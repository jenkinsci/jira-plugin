...
public class JiraProjectProperty extends JobProperty<Job<?, ?>> {
  ...
  /**
   * Used to find {@link JiraSite}. Matches {@link JiraSite#getName()}. Always non-null (but beware
   * that this value might become stale if the system config is changed.)
   */
  ...
  public static final class DescriptorImpl extends JobPropertyDescriptor {
    ...
    public void migrate() {
      ...
      if (descriptor != null) {
        descriptor
            .load(); // force readResolve without registering descriptor as configurable
      }
    }
    ...
    protected Object readResolve() {
      if (sites != null) {
        JiraGlobalConfiguration jiraGlobalConfiguration = (JiraGlobalConfiguration) Jenkins
            .getInstance()
