...
public class ExtendedAsynchronousVersionRestClient extends AsynchronousVersionRestClient implements
  ...
  public Promise<ExtendedVersion> createExtendedVersion(ExtendedVersionInput versionInput) {
    return postAndParse(versionRootUri, versionInput, new ExtendedVersionInputJsonGenerator(),
        new ExtendedVersionJsonParser());
  }

  @Override
  public Promise<ExtendedVersion> updateExtendedVersion(URI versionUri,
      ExtendedVersionInput versionInput) {
    return putAndParse(versionUri, versionInput, new ExtendedVersionInputJsonGenerator(),
        new ExtendedVersionJsonParser());
  }
}
