...
public class JiraIssueExtractionBuilder extends Builder  {
    ...
    PrintWriter getPrintWriter(String filePath) throws FileNotFoundException {
    ...
    public boolean perform(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener) throws InterruptedException, IOException {
        ...
        PrintWriter writer = getPrintWriter(realPropertiesFilePath);
        writer.println(realIssuesPropertyName+"="+idList);
        writer.close();
