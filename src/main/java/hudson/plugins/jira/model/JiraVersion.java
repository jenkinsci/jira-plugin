...
public class JiraVersion implements Comparable<JiraVersion> {
  ...
  @Deprecated
  public JiraVersion(String name, Calendar startDate, Calendar releaseDate, boolean released,
      boolean archived) {
    this.name = name;
  ...
  public JiraVersion(String name, String description, Calendar startDate, Calendar releaseDate,
      boolean released, boolean archived) {
    this.name = name;
  ...
  public JiraVersion(Version version) {
    this(version.getName(), version.getReleaseDate() == null ? null
            : version.getReleaseDate().toGregorianCalendar(), version.isReleased(),
        version.isArchived());
  }
  ...
  public JiraVersion(ExtendedVersion version) {
    this(version.getName(),
        ...
        version.getReleaseDate() == null ? null
