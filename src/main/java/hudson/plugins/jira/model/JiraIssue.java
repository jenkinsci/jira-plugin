...
/**
 * One Jira issue. This class is used to persist crucial issue information so that Jenkins can
 * display it without talking to Jira.
 *
...
public final class JiraIssue implements Comparable<JiraIssue> {
  ...
  /**
   * @return Summary of the issue. For example, in case of MNG-1235, this is "NPE In DiagnosisUtils
   * while using tomcat plugin"
   */
  @Exported
