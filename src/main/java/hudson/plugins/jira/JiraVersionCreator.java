 ...
 * @deprecated Replaced by {@link JiraVersionCreatorBuilder}. Read its description to see why. Kept
...
public class JiraVersionCreator extends Notifier {
  ...
  public boolean perform(AbstractBuild<?, ?> build, Launcher launcher, BuildListener listener) {
    return new VersionCreator()
        .perform(build.getProject(), jiraVersion, jiraProjectKey, build, listener);
  }
  ...
  public static class DescriptorImpl extends BuildStepDescriptor<Publisher> {
    ...
    @Override
    public JiraVersionCreator newInstance(StaplerRequest req, JSONObject formData)
