...
public class JiraVersionParameterDefinition extends ParameterDefinition {
  ...
  public JiraVersionParameterDefinition(String name, String description, String jiraProjectKey,
      String jiraReleasePattern, String jiraShowReleased, String jiraShowArchived) {
  ...
  public List<JiraVersionParameterDefinition.Result> getVersions() throws IOException {
    ...
    if (site == null) {
      throw new IllegalStateException(
          "Jira site needs to be configured in the project " + context.getFullDisplayName());
    }
