...
/**
 * This comparator can ordering the following formats versions: 9.9.9.9.9 V-5.2.3 PDFREPORT-2.3.4
 * PDFREPORT-2.3 1.12.2.3.4 1.3.4 1.1.1.2 1.1.1.1
 */
public class VersionComparator implements Comparator<Version> {
  ...
  public int compare(Version rev1, Version rev2) {
    ComparableVersion comparableVersion1 = new ComparableVersion(
        getNumberVersion(rev1.getName()));
    ComparableVersion comparableVersion2 = new ComparableVersion(
        getNumberVersion(rev2.getName()));
